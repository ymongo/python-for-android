...
class LibtorrentRecipe(Recipe):
    ...
    # Todo: bump version number when final version released...still not available at time of writing.
    # url = 'https://github.com/arvidn/libtorrent/archive/libtorrent_1_2_0.tar.gz'
    url = 'https://github.com/arvidn/libtorrent/releases/download/libtorrent-1_2-RC2/libtorrent-rasterbar-1.2.0-RC2.tar.gz'
    ...
    patches = ['disable-so-version.patch',
               ...
               # Todo: remove below patch when released version 1.2.0
               'fix-boost-python3.patch']
